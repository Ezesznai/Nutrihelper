...
namespace NutriHelper
{
    public partial class Form7 : Form
    {
        ...
        {
			lblfood_description.Text = Comida.foods.food[1].food_description;
        ...
        {
			lblfood_description.Text = Comida.foods.food[2].food_description;
        ...
        {
			lblfood_description.Text = Comida.foods.food[3].food_description;
        ...
        {
			lblfood_description.Text = Comida.foods.food[4].food_description;
        ...
        {
			lblfood_description.Text = Comida.foods.food[5].food_description;
        ...
        {
			lblfood_description.Text = Comida.foods.food[6].food_description;
        ...
        {
			lblfood_description.Text = Comida.foods.food[7].food_description;
        ...
        {
			lblfood_description.Text = Comida.foods.food[8].food_description;
        ...
        {
			lblfood_description.Text = Comida.foods.food[9].food_description;
        ...
        private void BtnOK_Click(object sender, EventArgs e)
        {
            ...
            Datos.kcal_porcion = Math.Round(((Convert.ToDouble(kcal_comidas[0]) / 100) * Datos.CantPorcion), 0);
			lblkcal.Text = Convert.ToString(Datos.kcal_porcion);
			Convert.ToInt16(Datos.kcal_porcion);

			OleDbCommand kcal;
			db.Open();
			//kcal = new OleDbCommand("UPDATE Comidas SET kcal, gramos = " + Datos.kcal_porcion + Datos.CantPorcion + " WHERE nombre ='" + Datos.nombre + "'");
			//kcal = new OleDbCommand("UPDATE Comidas SET kcal_comida = " + Datos.kcal_porcion + ", gramos = " + Datos.CantPorcion + ", tipo = "+ Datos.tipo + ",comida = " +  " WHERE nombre ='" + Datos.nombre + "'");
			kcal = new OleDbCommand("INSERT INTO Comidas (nombre, kcal_comida, tipo, gramos, comida) VALUES ('" + Datos.nombre + "', '" + Datos.kcal_porcion + "', '" + Datos.tipo + "', '" + Datos.CantPorcion + "', '" + Datos.busquedaAPI + "')", db);
